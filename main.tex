...
\begin{figure}[H]
	...
	\subcaption*{\textit{Nota:} Extraída de \citeauthor{pantallasChange} (s.f.)}
    \end{subfigure}
	\label{fig:hospital}
\end{figure}
...
\begin{figure}[H]
	...
	\subcaption*{\textit{Nota:} Extraída de \citeauthor{lacapitalColectivos} (s.f.)}
    \end{subfigure}
	\label{fig:colectivo}
\end{figure}
\vspace{-1.0\baselineskip}
...
\begin{figure}[H]
	...
	\subcaption*{\textit{Nota:} Extraída de \citeauthor{playStorePreguntados} (s.f.)}
    \end{subfigure}
...
\begin{figure}[H]
	\caption{Gráfico de calificaciones para lenguajes frontend}
...
Al asignar pesos como calificaciones a los atributos a evaluar, y luego hacer lo mismo a los atributos de cada tecnología, se llegó a la distribución que se muestra en la fig.~\ref{fig:frameworksCSS}.
\begin{figure}[H]
	\caption{Gráfico de calificaciones para frameworks CSS}
    \begin{subfigure}{0.7\textwidth}
...
\begin{figure}[H]
	...
	\subcaption*{\textit{Nota:} Extraída de Stack Overflow Survey (2022)}
    \end{subfigure}
...
\begin{figure}[H]
	...
	\subcaption*{\textit{Nota:} Extraída de Jet Brains Survey of 183 countries/regions (2021)}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{1\textwidth}
	\includegraphics[width=0.5\textwidth]{sirhc pantalla principal.png}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{1\textwidth}
	\includegraphics[width=0.5\textwidth]{sirhc editor de puesto.png}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{1\textwidth}
	\includegraphics[width=0.5\textwidth]{sirhc editor de puestos avanzado.png}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{1\textwidth}
	\includegraphics[width=0.5\textwidth]{sirhc editor de trivias.png}
    \end{subfigure}
...
\begin{figure}[H]
	\caption{Interfaz de la pantalla principal del sistema}
    \begin{subfigure}{1\textwidth}
	\includegraphics[width=0.9\textwidth]{sirhc pantalla principal.png}
    \end{subfigure}
...
\begin{figure}[H]
	\caption{Interfaz del editor de puesto}
    \begin{subfigure}{1\textwidth}
	\includegraphics[width=0.9\textwidth]{sirhc editor de puesto.png}
    \end{subfigure}
...
\begin{figure}[H]
	\caption{Interfaz del editor de puestos avanzado}
    \begin{subfigure}{1\textwidth}
	\includegraphics[width=0.9\textwidth]{sirhc editor de puestos avanzado.png}
    \end{subfigure}
...
\begin{figure}[H]
	\caption{Interfaz del editor de trivias}
    \begin{subfigure}{1\textwidth}
	\includegraphics[width=0.9\textwidth]{sirhc editor de trivias.png}
    \end{subfigure}
